---
title: "布局"
permalink: /mmistakes/layouts/
excerpt: "介绍主题包含的布局以及如何使用等。"
single_layout_gallery:
  - image_path: /assets/images/mm-layout-single-header.png
    alt: "single layout with header example"
  - image_path: /assets/images/mm-layout-single-meta.png
    alt: "single layout with comments and related posts"
last_modified_at: 2025-11-12T21:27:40-04:00
toc: true
toc_label: "所有布局"
toc_icon: "columns"
---

主题的全部知识都在这里。下面你会发现 Minimal Mistakes 主题的布局、它们的显示方式和它们对应的构建内容类型等。

## 默认布局

所有布局都衍生于基础布局。该布局包含了来自 `_includes` 的几部分：
...
**注记：** You won't ever assign this layout directly to a post or page. Instead all other layouts will build off of it by setting `layout: default` in their YAML Front Matter.
{: .notice--warning}
